package com.Iptv_Aqif.akDeveloper;
...
import com.Iptv_Aqif.akDeveloper.adapter.PlaylistAdapter;
import com.Iptv_Aqif.akDeveloper.models.PlaylistData;
import com.Iptv_Aqif.akDeveloper.models.PlaylistResponse;
import com.Iptv_Aqif.akDeveloper.util.HttpHandler;
import com.Iptv_Aqif.akDeveloper.util.RecyclerTouchListener;
import com.Iptv_Aqif.akDeveloper.util.SharedPrefManager;
    ...
    private void loadMain() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    Document doc = Jsoup.connect("https://raw.githubusercontent.com/firebase55/aqib_iptv/master/aqib_ip").get();
